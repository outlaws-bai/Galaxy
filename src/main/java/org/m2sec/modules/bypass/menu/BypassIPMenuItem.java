...
public class BypassIPMenuItem extends AbstractMenuItem {
    ...
    public void action(ContextMenuEvent event) {
        ...
        headers.put("X-Forwarded-For", ip)
                .put("X-Originating-IP", ip)
                .put("X-Remote-IP", ip)
                .put("X-Remote-Addr", ip)
                .put("X-Real-IP", ip)
                .put("X-Forwarded", ip)
                .put("X-Forwarded-Host", ip)
                .put("X-Client-IP", ip)
                .put("X-ProxyUser-Ip", ip)
                .put("X-Original-URL", ip)
                .put("Client-IP", ip)
                .put("True-Client-IP", ip)
                .put("Cluster-Client-IP", ip)
                .put("X-Host", ip);
