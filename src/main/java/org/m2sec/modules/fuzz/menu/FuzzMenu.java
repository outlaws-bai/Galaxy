...
public class FuzzMenu extends AbstractMenu {
    ...
    public List<AbstractMenuItem> getSubMenuItems() {
        return new ArrayList<>(List.of(new FuzzSensitivePathMenuItem(), new FuzzSensitivePathAndBypassMenuItem(),
            new FuzzSwaggerDocsMenuItem(), new ExtractInfoDictMenuItem()));
    }
}
