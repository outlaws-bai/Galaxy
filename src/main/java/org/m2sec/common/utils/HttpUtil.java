...
import org.m2sec.common.models.FormDatas;
...
public class HttpUtil {
    ...
    public static <T extends Parameters<String>> T strToParameters(
            String str, String sep, String conn, Class<? extends T> clazz) {
        try {
    ...
    public static <T extends Parameters<String>> String parametersToStr(
            T parameters, String sep, String conn, boolean urlEncodeValue) {
    ...
    public static ContentType getContentType(
            String method, @Nullable String contentTypeHeaderValue) {
        if (Method.GET.toString().equalsIgnoreCase(method)
                || Method.OPTIONS.toString().equalsIgnoreCase(method)
                || Method.HEAD.toString().equalsIgnoreCase(method)) {
    ...
    public static byte[] generateContentFormDataContent(
            String boundary, FormDatas<String> formDatas, FormDatas<UploadFile> files) {
            ...
            for (Map.Entry<String, List<UploadFile>> entry : files.entrySet()) {
                ...
                for (UploadFile uploadFile : entry.getValue()) {
                    ...
                    for (Map.Entry<String, List<String>> header :
                            uploadFile.getHeaders().entrySet()) {
