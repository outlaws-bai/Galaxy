 ...
 * @description:
 */
public class HttpHookGrpcServer {
    ...
    public HttpHookGrpcServer(int port) {
        this.port = port;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        final HttpHookGrpcServer server = new HttpHookGrpcServer(port);
        server.start();
    ...
    static class RpcServiceImpl extends HttpHookServiceGrpc.HttpHookServiceImplBase {
        ...
        private static byte[] getData(byte[] content) {
            return Base64.getDecoder().decode((String) JsonUtil.jsonStrToMap(new String(content)).get("data"));
        }
